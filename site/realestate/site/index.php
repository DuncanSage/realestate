...
<html lang="en">
<head>
	<title>Allison Whaites - Real Estate</title>
	<meta charset="UTF-8">
...
<body>
	...
	<!-- Hero section -->
	<section class="hero-section set-bg" data-setbg="img/bg6.jpg">
	...
	<section class="services-section spad set-bg"><!--  data-setbg="img/service-bg.jpg" -->
		<div class="container">
			<div class="row">
				...
				<!-- <div class="col-lg-6">
					<img src="img/profile.jpg" alt="Allison Whaites" style="margin-left: 100px">
				</div> -->
	...
	<section class="feature-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<p>Featured houses for sale</p>
			</div>
			<div class="row">

<!-- <?php 

$sql = "SELECT `properties`.*, `salesrep`.`firstname`, `salesrep`.`lastname`
FROM `properties`
INNER JOIN `salesrep` ON `salesrep`.`id` = `properties`.`repid`";

// $sql = "SELECT * FROM `properties` WHERE `active` = 1 and featured = 1";
...
$datediff = round($datediff / (60 * 60 * 24));
 ...
 ?> -->
<!--================================ block repeating for featuerd items ================================-->
				<!-- <div class="col-lg-4 col-md-6">
					<div class="feature-item">
						<div class="feature-pic set-bg" data-setbg="img/properties/<?php //echo $row['id']. '/' .$row['image1']?>">
							<div class="sale-notic">FOR SALE</div>
						</div>
							...
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
										...
										<?php
										// if ($row['size'] > 0) {
										// echo '<p><i class="fa fa-th-large"></i>'.$row['size'].' Square meters</p>';
										// 	}
										?>
									...
									<div class="rf-right">
										<p><i class="fa fa-car"></i><?php //echo $row['garage']; ?> Garages</p>
										<p><i class="fa fa-bath"></i><?php //echo $row['bathrooms']; ?> Bathrooms</p>
									</div>	
								</div>
								<div class="room-info">
									<div class="rf-left">
									...
									<div class="rf-right">
										<p><i class="fa fa-clock-o"></i><?php //echo $datediff; ?> days ago</p>
									</div>	
								</div>
							</div>
							<a href="#" class="room-price">$<?php //echo money_format('%i', $row['price']); ?></a>
						</div>
					</div>
				</div> -->
...
?> -->
<!-- Fetured items with out database -->
				<div class="col-lg-4 col-md-6">
					<!-- feature -->
					<div class="feature-item">
						<div class="feature-pic set-bg" data-setbg="img/properties/1/h1.jpg">
							<div class="sale-notice">FOR SALE</div>
						</div>
						<div class="feature-text">
							<div class="text-center feature-title">
								<h5>180 Turf Street</h5>
								<p><i class="fa fa-map-marker"></i>180 Turf Street Grafton NSW 2460</p>
							</div>
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
										<p><i class="fa fa-th-large"></i> 558m<sup>2</sup> </p>
							...
							<a href="http://www.fngrafton.com.au/real-estate/1238184/2-15-gosford-close-grafton-nsw-2460" class="room-price">$375,000</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					<!-- feature -->
					<div class="feature-item">
						<div class="feature-pic set-bg" data-setbg="img/properties/2/h2.jpg">
							<div class="sale-notice">FOR SALE</div>
						</div>
						<div class="feature-text">
							<div class="text-center feature-title">
								<h5> 2/15 Gosford Close</h5>
								<p><i class="fa fa-map-marker"></i> 2/15 Gosford Close Grafton NSW 2460</p>
							</div>
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
										<p><i class="fa fa-th-large"></i> 673m<sup>2</sup></p>
							...
							<a href="http://www.fngrafton.com.au/real-estate/1179561/180-turf-street-grafton-nsw-2460" class="room-price">$327,000</a>
						</div>
					</div>
				</div>
	...
	<section class="feature-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<p>Featured houses for rent</p>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<!-- feature -->
					<div class="feature-item">
						<div class="feature-pic set-bg" data-setbg="img/properties/3/h3.jpg">
							<div class="rent-notice">FOR RENT</div>
						</div>
						<div class="feature-text">
							<div class="text-center feature-title">
								<h5>1 Macpherson Crescent</h5>
								<p><i class="fa fa-map-marker"></i> 1 Macpherson Crescent Grafton NSW 2460</p>
							</div>
							<div class="room-info-warp">
								<div class="room-info">
									<div class="rf-left">
